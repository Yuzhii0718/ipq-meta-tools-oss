...
def main():
    ...
    if ARCH_NAME != "ipq806x":
        ...
        for entry in entries:
            ...
            q6_uses_pcie0 =  entry.find(".//q6_uses_pcie0")
            q6_uses_pcie1 =  entry.find(".//q6_uses_pcie1")
            q6_uses_pcie2 =  entry.find(".//q6_uses_pcie2")
            data_retention =  entry.find(".//data_retention")
            ...
            if ARCH_NAME == "ipq6018":
                if data_retention != None:
                    if data_retention.text == "true":
                        boot_settings = root_cdt.find(".//device[@id='cdb2']/props[@name='boot_settings']")
                        # overwritting Bit 15 for DDR data retention
                        boot_settings.text = str(int(boot_settings.text) | 32768)
            ...
            if ARCH_NAME == "ipq5332":
                ...
                if q6_uses_pcie0 != None:
                    if q6_uses_pcie0.text == "true":
                        boot_settings = root_cdt.find(".//device[@id='cdb2']/props[@name='boot_settings']")
                        # overwritting Bit 16 for qcn9160 on pcie0
                        boot_settings.text = str(int(boot_settings.text) | 65536)

                if q6_uses_pcie1 != None:
                    if q6_uses_pcie1.text == "true":
                        boot_settings = root_cdt.find(".//device[@id='cdb2']/props[@name='boot_settings']")
                        # overwritting Bit 17 for qcn9160 on pcie1
                        boot_settings.text = str(int(boot_settings.text) | 131072)

                if q6_uses_pcie2 != None:
                    if q6_uses_pcie2.text == "true":
                        boot_settings = root_cdt.find(".//device[@id='cdb2']/props[@name='boot_settings']")
